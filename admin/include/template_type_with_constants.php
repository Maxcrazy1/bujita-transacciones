...
if($template_data['is_fixed'] == '0') {
	$constants_array = array(
		...
		'{$order_item_locks}');
} elseif($template_data['type']=="order_payment_status_paid_alert_email_to_customer") {
	$constants_array = array(
		'{$logo}','{$header_logo}','{$footer_logo}',
		'{$admin_logo}',
		'{$admin_email}',
	...
	$constants_array = array(
		...
		'{$verification_link}',
		'{$admin_phone}');
} elseif($template_data['type']=="shipment_label_email_to_customer" || $template_data['type']=="new_order_email_to_customer" || $template_data['type']=="new_order_email_to_admin") {
	$constants_array = array(
		'{$logo}','{$header_logo}','{$footer_logo}',
		'{$admin_logo}',
		'{$admin_email}',
