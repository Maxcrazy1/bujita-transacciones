...
$Color_ID = $excel_file_data[18];
$Color_Title = real_escape_string($excel_file_data[19]);
$Color_Code = $excel_file_data[20];
$Color_Price = $excel_file_data[21];
$Condition_ID = $excel_file_data[22];
$Condition_Title = real_escape_string($excel_file_data[23]);
$Condition_Price = $excel_file_data[24];
$Accessories_ID = $excel_file_data[25];
$Accessories_Title = real_escape_string($excel_file_data[26]);
$Accessories_Price = $excel_file_data[27];
