					...
					<div class="tab-pane active">
						...
						<div class="tabbable tabs-left">
							<ul class="nav nav-tabs">
                                ...
                                <?php
                                if($id>0) { ?>
                                <li><a href="#" onclick="PricingModal();return false;">Pricing</a></li>
                                <?php
                                } ?>
...
<div class="modal primary fade" id="pricing_modal" style="min-width:800px;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h3 class="modal-title">Edit Pricing <small><b>For <?=$mobile_data['title']?></b></small></h3>
			</div>
			<!-- /Modal header -->
