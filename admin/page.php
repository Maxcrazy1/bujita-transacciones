...
$page_p_query = mysqli_query($db,"SELECT COUNT(*) AS num_of_pages FROM pages");
$page_p_data = mysqli_fetch_assoc($page_p_query);
$pages->set_total($page_p_data['num_of_pages']);

$query = mysqli_query($db,"SELECT * FROM pages ORDER BY type DESC, id ASC ".$pages->get_limit()."");
...
$inbuild_page_array = array(
	...
	array('name'=>'Sell my mobile','title'=>'Sell my mobile','slug'=>'sell-my-mobile','url'=>'sell-my-mobile'),
	...
	array('name'=>'Posting Instructions','title'=>'Posting Instructions','slug'=>'posting-instructions','url'=>'posting-instructions'),
	array('name'=>'Packaging Instruction','title'=>'Packaging Instruction','slug'=>'packaging-instructions','url'=>'packaging-instructions'),
);
