...
include("include/header.php"); ?>
  ...
  <section id="tell_us_phone" class="nch">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-5">
                ...
                <ul class="about_brand_logo clearfix">
                  ...
                  <li>
                    <a target="_blank" href="https://www.5miles.com/s/cashmovil">
                ...
                <p class="text-center"><a class="trust_pilot" href="https://www.trustpilot.com/review/cashmovil"><img class="trust_pilot" src="<?=SITE_URL?>images/Trustpilot_logo.png" alt=""></a></p>
              </div>
              <div class="col-md-7">
			  	<?php
                ...
                <div class="h1 border-line"><?=$main_sub_title?></div>
				<?=$description?><?php */?>
              </div>
            </div>
          </div>
