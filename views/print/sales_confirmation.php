...
elseif($user_id>0 && $user_id!=$order_detail['user_id']) {
	setRedirect(SITE_URL);
	exit();
}
...
<table cell-padding="0" cell-spacing="0" border="0;" width="100%" style="padding:5px 5px 5px 5px;background-color:#dddddd;" class="tbl-border-radius">
	<tbody>
		<tr>
			<th width="59%"><strong>Dispositivo/Modelo</strong></th>
			<th width="18%"><strong>IMEI Number</strong></th>
...
Envíelo o acérquese a una tienda colaboradora en un plazo de '.$order_expired_days.' dias<br>
Una vez recibido haremos el pago el mismo dia<br><br>
<strong>Mantente actualizado</strong><br>
ara ver el estado de su solicitud, por favor entra en tu Área Privada
contacta con nosotros en '.$site_email.' o llama al '.$site_phone.' en horario comercial.<br><br>
