...
$visitor_body .='<div style="padding-top:1em"><table  class="custom-table-2" border="0"  cellpadding="0" cellspacing="0"><thead>'
			.'<tr><th colspan="2" class="table-2-header">SENDING YOUR DEVICE TO US</th></tr>'
			.'<tr><td colspan="2" class="table-2-subheader">PLEASE, FOLLOW THE STEPS BELOW TO SHIP OR DELIVER YOUR DEVICE TO US</td></tr>'
			.'</thead><tbody><tr><td class="table-2-img"><img width="250px" src="'.SITE_URL.'images/prepare_your_device.png"></td>'
			.'<td><table style="width:100%" border="0"  cellpadding="0" cellspacing="0"><thead><tr>'
			.'<th class="table-2-ulheader">PREPARE YOUR DEVICE</th></tr></thead><tbody><tr><td>'
			.'<div><ul class="table-2-ul">'
			.'<li><p class="table-2-p">Remove or sign out from "Find my iPhone" for Apple devices and remove "Android Activation Lock" for Android devices. <strong class="table-2-strong">Not sure? Here\'s how to proceed</strong></p></li>'
			.'<li><p class="table-2-p">Remove any password protection service</p></li><li>'
			.'<p class="table-2-p">Reset device to "Factory Settings" if applicable. <strong class="table-2-strong">Not sure? Here\'s how to proceed</strong></p>'
			.'</li><li><p class="table-2-p">Fully Charge the device\'s battery</p></li></ul></div></td></tr></tbody>'
			.'</table></td></tr><tr><td class="table-2-img"><img width="250px" src="'.SITE_URL.'images/box.png"></td><td>'
			.'<table style="width:100%" border="0"  cellpadding="0" cellspacing="0"><thead><tr><th  class="table-2-ulheader">PACKAGE YOUR DEVICE PROPERLY</th></tr></thead>'
			.'<tbody><tr><td><div><ul class="table-2-ul"><li><p class="table-2-p">Secure device properly inside its packaging to prevent damage while in transit We recommend the use of bubble wraps and Styrofoam peanuts.</p></li>'
			.'<li><p class="table-2-p">Seal the package with a durable shipping tape.</p></li>'
			.'<li><p class="table-2-p">We are not accountable for any damages during shipping. This could force an offer review or lead to the cancellation of your offer.</p></li></ul></div></td></tr></tbody></table></td>'
			.'</tr><tr><td class="table-2-img"><img width="250px" src="'.SITE_URL.'images/printer.png"></td><td>'
			.'<table style="width:100%" border="0"  cellpadding="0" cellspacing="0"><thead><tr>'
			.'<th  class="table-2-ulheader">SHIPPING YOUR DEVICE</th></tr></thead><tbody>'
			.'<tr><td><div><ul class="table-2-ul"><li><p class="table-2-p">Print the prepaid shipping label below, and attach it securely with a tape to your pacage.</p></li>'
			.'<li><p class="table-2-p">Leave us a message if you don\'t have a printer, and we will mail you a printed label. You can also use the printer at a local library.</p></li>'
			.'<li><p class="table-2-p">Drop off the package at a USPS location closest you. Ensure that it is marked "Fragile" at the counter.</p>'
			.'</li><li><p class="table-2-p">Your offer is guaranteed to be locked for 21 days. Be sure or deliver your device within this period to avoid cancellation of your offer.</p>'
			.'</li></ul></div></td></tbody></table></td></tr></tbody><tfoot><tr><th colspan="2" align="center"><div style="display: inline-block;background: white;border-radius: 14px;padding: 0.4em;margin-bottom: 1em;"><img width="250px" class="table-2-footer-img" src="'.SITE_URL.'images/usps_logo.png"></div></th></tr></tfoot></table></div>';
